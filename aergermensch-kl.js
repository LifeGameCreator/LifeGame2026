(() => {
  ...
  const AM_VERSION = "2026-07-24-bot-party-repair-v6";
  ...
  async function amStartLocal(shell) {
    try {
      ...
      console.error("ÄrgerMensch.KL Bot-Partie", error);
  ...
  document.addEventListener("click", (event) => {
    ...
    setTimeout(() => {
      if (!amRuntime.overlay?.classList.contains("show")) {
        console.warn("ÄrgerMensch.KL: regulärer Start blieb aus, Fallback wird verwendet.");
